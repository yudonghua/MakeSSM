...
public class Controller {
    ...
    public static void getController(String table,String entity){
        ...
        String params=param.replaceAll("xxx",beans[0]);
        String content="package com.view;\r\n" +
                ...
                "    public String searchXxx(HttpServletRequest req,@RequestParam String name){\r\n" +
                "        List<Xxx> xxxs = xxxService.searchXxx(name);\r\n" +
                "        System.out.println(xxxs);\r\n" +
                "        req.setAttribute(\"xxxs\", xxxs);\r\n" +
                "        return \"listXxx\";\r\n" +
                "    }\r\n" +
                "\r\n" +
